export const en = {
    ...
    showcase: {
      ...
      stat1Value: '70%',
      stat1Label: 'CHEAPER THAN DIRECT',
      stat2Value: '~3s',
      stat2Label: 'QRIS TOP-UP TIME',
      stat3Value: '4+',
      stat3Label: 'FLAGSHIP PROVIDERS',
      stat4Value: '142ms',
      stat4Label: 'MEDIAN ROUTE LATENCY',
      ...
      card1Desc: 'Seamlessly integrates with any OpenAI SDK, Cursor, Cline, or Windsurf. Just change the baseURL and start coding.',
      ...
      card6Desc: 'Your code and prompts are never stored, logged, or used for model training. API keys are sealed in military-grade encrypted vaults.',
      card7Title: 'Automatic multi-provider failover',
      card7Desc: 'Intelligent traffic router seamlessly switches upstream clusters when a provider hits downtime or rate limits. Never lose your coding flow.',
    },
    steps: {
